LEXICON: dict[str, str] = {
    ...
    '/help': '<b>Свиное сердце 2</b>\n\nКнига стихотворений\nАлексея Денисова\n'
             ...
             'Привет! \nЯ прототип бота-читалки и еще буду развиваться. Так что если я вдруг что-то не то делаю, '
             'значит, на меня накатили обновления и меня лучше запустить заново, отправив сообщение "/start".\n\n'
             'Что еще? Я пока не разговариваю. И не знаю, буду ли. Зачем бы это? Так что на любое просто сообщение '
             'буду рандомно отправлять стишок из книжки.\n\n'
             'Чтобы сохранить закладку - нажмите на кнопку с номером страницы. \n'
             'Для остального есть меню.',
